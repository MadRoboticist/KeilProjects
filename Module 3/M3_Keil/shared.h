...
#define COPYRIGHT "Copyright (c) University of Colorado" 
 ...
 enum dmode {QUIET, NORMAL, DEBUG, VERSION, LED}; 
...
/************************************************************************/
 ...
 extern bool TXflag;                       // like a binary semaphore
...
extern void UART_direct_word_hex_put(uint32_t word); /* located in module UART_poll.c */
